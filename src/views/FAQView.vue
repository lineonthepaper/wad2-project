  ...
  data() {
    return {
      ...
      faqItems: [
        ...
        { id: 'l3', category: 'labels', question: 'What kind of printer and paper should I use to print ezy2ship labels?', answer: 'Use only white paper printed on a laser or high quality ink jet printer. Self-adhesive labels with thermal / label printer are also acceptable.' },
        ...
        { id: 't2', category: 'tracking', question: 'How do I track my shipment from ezy2ship?', answer: 'If you have a registered account, you can track your shipments under History/Tracking – Shipments history screen. <br>Alternatively, tracking is also available: <br>Speedpost items – <a href="https://www.speedpost.com.sg/" target="_blank">www.speedpost.com.sg</a> or SingPost mobile app <br>Mail items – <a href="https://www.singpost.com/" target="_blank"> www.singpost.com</a> or SingPost mobile app' },
        { id: 't3', category: 'tracking', question: 'Can I obtain proof of delivery from ezy2ship?', answer: 'If you wish to obtain a copy of the proof of delivery for Speedpost items and Registered Service items (subject to additional charges), please call our SingPost customer service hotline at 1605.' },
        
        // Registration
        { id: 'r1', category: 'registration', question: 'How do I register for ezy2ship?', answer: 'You may register as a user by clicking on "Sign Up" on the ezy2ship login page' },
